...
employees = requests.get('https://jsonplaceholder.typicode.com/users/{}'.format(employee_id))
...
if __name__ == "__main__":
    '''
    after data is found it is output
    '''
    print('Employee {} is done with tasks({}/{})'.format(employees_info, task_completed_count, task_count))
